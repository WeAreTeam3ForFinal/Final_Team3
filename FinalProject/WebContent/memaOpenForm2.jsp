...
<body>
	...
	<div class="pagewrap">
		...
		<section id="section" class=" border border-secondary border border-3 bg-transparent text-dark">
			...
			<div class="main row g-2">
					<div class="col-md-6">
    					 ...
    					 <input type="text" class="form-control form-control-date" id="datetime" placeholder="클릭하여 선택해주세요." required>
						<!-- 공백란 경고문구 부분 -->
					...
					<div class="col-md-6">
    					 ...
    					 <input type="text" class="form-control" id="local" onclick="openPopUp('/FinalProject/kakaomap.jsp','나는카카오맵')" placeholder="내용을 입력해주세요" required>
						<!-- 공백란 경고문구 부분 -->
					...
					<div class="col-md-12">
    					 ...
    					 <input type="text" class="form-control" id="restautant" placeholder="내용을 입력해주세요" required>
						<!-- 공백란 경고문구 부분 -->
				...
				<div class=" col-md-6">
					...
					<div class="col-md-6">
						<span class="red">※</span> 
    					 ...
    					 <input type="text" class="form-control" id="mainMenu" placeholder="내용을 입력해주세요" required>
						<!-- 공백란 경고문구 부분 -->
					...
					<span class="red">※</span> 
    					 ...
    					 <input type="text" class="form-control" onkeyup="perPriceCal()" id="mainMenuPrice" placeholder="내용을 입력해주세요">(원)
					...
					<div class="col-md-4">
						<span class="red">※</span> 
    					 ...
    					 <input type="text" class="form-control" onkeyup="perPriceCal()" id="peopleCount" placeholder="내용을 입력해주세요">(명)
					...
					<div class="col-md-4">
						<span class="blue">※</span> 
    					 ...
    					 <input type="text" class="form-control" readonly="readonly"  id="perPrice" placeholder="내용을 입력해주세요">(원)
					</div>
					<br>
					<div class="col-md-12">
		...
		<div class="button_box">
			<button id="mm_open" type="submit" class="btn btn-warning" opCtn="개설이 완료되었습니다." opBtn="메인페이지로 돌아갑니다." opBtnHref="MainPage.jsp" data-bs-toggle="modal" data-bs-target="#oneBtnPopup" onclick="oneBtnPopOpen('#mm_open')">개설하기</button>
