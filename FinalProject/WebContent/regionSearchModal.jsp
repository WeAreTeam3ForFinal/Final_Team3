...
<script>
	...
	$(function()
	{
		...
		$("#loadAddrModal").click(function()
		{
			$("#city_province_list").empty();
 ...
 */
					...
					$("#city_province_list").append(city_province_option);
					...
					<div class="row gy-2 justify-content-md-center ">
						<div class="col-5 ">
							<div class="align-items-center form-outline ">
								...
								<select class="form-select rounded" id="city_province_list">
					...
					<div class="row gy-2 justify-content-md-center ">
						<div class="col-12">
							<div class="input-group align-items-center form-outline">
								...
								<div id="User_addrRec" class="col-12 form-outline">
